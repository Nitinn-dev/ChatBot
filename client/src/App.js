...
function App() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            const geminiResponse = response.data.response;
            setChatHistory(prev => [...prev, { role: 'model', text: geminiResponse }]);
        ...
        <div className="app-container">
            ...
            <div className="chat-area">
                <div className="chat-messages" ref={chatContainerRef}>
                    ...
                    {isLoading && (
                        <div className="chat-bubble-wrapper model loading">
                            <div className="chat-bubble">
                ...
                <div className="input-area">
                    <textarea
                        ...
                        disabled={isLoading}
                    ></textarea>
                    <button onClick={handleSendMessage} disabled={isLoading || !prompt.trim()}>
